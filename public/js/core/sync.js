...
function hydrateVars(){
  ...
  if(typeof BESTLERN!=='undefined'){ BESTLERN=loadJSON('hkl_bestlern',{}); if(!BESTLERN||typeof BESTLERN!=='object'||Array.isArray(BESTLERN)) BESTLERN={}; }
